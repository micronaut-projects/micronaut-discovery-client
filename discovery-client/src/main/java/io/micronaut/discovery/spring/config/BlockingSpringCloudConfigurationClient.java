...
/**
 * A {@link BlockingConfigurationClient} for Spring Cloud client.
 *
...
public class BlockingSpringCloudConfigurationClient implements BlockingConfigurationClient {

    private static final Logger LOG = LoggerFactory.getLogger(BlockingSpringCloudConfigurationClient.class);
     ...
     */
    protected BlockingSpringCloudConfigurationClient(BlockingSpringCloudConfigClient springCloudConfigClient,
