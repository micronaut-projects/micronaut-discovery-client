...
public class MockingVaultServerV1Controller {
    ...
    public static final String PATH_PREFIX = "mock/v1/path/prefix";

    @Get("/v1/backendv1/{vaultKey:.*}")
    public Publisher<VaultResponseV1> readConfigurationValuesV1(@NonNull String vaultKey) {
    ...
    @Get("/v1/backendv1-prefixed/{vaultKey:.*}")
    public Publisher<VaultResponseV1> readPrefixedConfigurationValuesV1(@NonNull String vaultKey) {
        Map<String, Object> properties = new HashMap<>();

        if (vaultKey.equals(PATH_PREFIX + "/myapp/second")) {
            properties.put("v1-prefixed-secret-1", 1);
        } else if (vaultKey.equals(PATH_PREFIX + "/application/second")) {
            properties.put("v1-prefixed-secret-1", 2);
            properties.put("v1-prefixed-secret-2", 1);
        } else if (vaultKey.equals(PATH_PREFIX + "/myapp/first")) {
            properties.put("v1-prefixed-secret-1", 3);
            properties.put("v1-prefixed-secret-2", 2);
            properties.put("v1-prefixed-secret-3", 1);
        } else if (vaultKey.equals(PATH_PREFIX + "/application/first")) {
            properties.put("v1-prefixed-secret-1", 4);
            properties.put("v1-prefixed-secret-2", 3);
            properties.put("v1-prefixed-secret-3", 2);
            properties.put("v1-prefixed-secret-4", 1);
        } else if (vaultKey.equals(PATH_PREFIX + "/myapp")) {
            properties.put("v1-prefixed-secret-1", 5);
            properties.put("v1-prefixed-secret-2", 4);
            properties.put("v1-prefixed-secret-3", 3);
            properties.put("v1-prefixed-secret-4", 2);
            properties.put("v1-prefixed-secret-5", 1);
        } else if (vaultKey.equals(PATH_PREFIX + "/application")) {
            properties.put("v1-prefixed-secret-1", 6);
            properties.put("v1-prefixed-secret-2", 5);
            properties.put("v1-prefixed-secret-3", 4);
            properties.put("v1-prefixed-secret-4", 3);
            properties.put("v1-prefixed-secret-5", 2);
            properties.put("v1-prefixed-secret-6", 1);
        } else {
            return Publishers.empty();
        }
    ...
    private VaultResponseV1 buildVaultResponse(Map<String, Object> properties) {
        return new VaultResponseV1(properties,
            null,
            null,
            null,
