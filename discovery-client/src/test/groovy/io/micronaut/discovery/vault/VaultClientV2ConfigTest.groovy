...
import io.micronaut.discovery.vault.config.v2.VaultConfigBlockingHttpClientV2
...
class VaultClientV2ConfigTest extends Specification {
    ...
    void "test configuration order"() {
        ...
        context.getBean(VaultConfigBlockingHttpClientV2).description == VaultConfigBlockingHttpClientV2.CLIENT_DESCRIPTION
